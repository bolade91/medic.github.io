...
/*if(isset($_SESSION["reservation_paypal_list"])) {
	$reservationObj->confirmReservations($_SESSION["reservation_paypal_list"]);
} */
...
<div style="text-align:center;width:960px; margin: 100px auto 0;">
	<div style="font-size: 30px;"><?php echo $langObj->getLabel("PAYPAL_CONFIRM_CONFIRMED_1"); ?></div>
    <div style="font-size: 20px; margin-top: 20px;"><?php echo $langObj->getLabel("PAYPAL_CONFIRM_CONFIRMED_2"); ?></div>
